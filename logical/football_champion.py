...
conceded, and returns the team name with the highest number of points.
...
def football_champion(teams):
    ...
    for team in teams:
        ...
        if points > max_ponts or (points == max_ponts and goal_difference > max_goal_difference):
            max_ponts = points
